...
public class CreateMenu {
	...
	public   Menu getMenu() throws UnsupportedEncodingException {
		...
		String reurl =URLEncoder.encode("http://www.juhuaihua.cn/vote.do","utf-8");
		btn22.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxc82f3a1b0a17373d&redirect_uri="+reurl+"&response_type=code&scope=snsapi_base&state=STATE&connect_redirect=1#wechat_redirect");
